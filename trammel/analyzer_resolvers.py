"""Per-language import-graph resolvers for the regex analyzer engine.

Split out of :mod:`analyzer_engine` to keep that module under the project's
500-LOC target. Each resolver takes ``(AnalyzerSpec, project_root)`` and
returns ``{file: [deps...]}``; they are dispatched by spec ``import_scheme``
from within :class:`~.analyzer_engine.RegexAnalyzerEngine`.
"""
...
from .analyzer_specs import AnalyzerSpec
from .utils import (
